...
/*
	objectPool = isobus::IOPFileInterface::read_iop_file("object_pool/object_pool.iop");
...
*/
	...
	VTClientInterface->set_object_pool(0, testPool, (object_pool_end - object_pool_start) - 1, objectPoolHash);
